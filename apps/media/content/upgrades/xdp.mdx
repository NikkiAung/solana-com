...
two-thirds of network stake crossed over to XDP on June 30, 2026 at 18:36 UTC —
supermajority adoption. With Agave 4.1, XDP's experimental label was removed,
and it is scheduled to become the default in Agave 4.2. The Firedancer client
has used XDP by default since inception.

|                  |                                                                                                             |
| ---------------- | ----------------------------------------------------------------------------------------------------------- |
| Status           | 🟢 Supermajority (>2/3) of stake adopted as of June 30, 2026                                                |
| Protocol Change? | No                                                                                                          |
| Breaking Change? | No                                                                                                          |
| Action Required? | No longer required for new Agave validators once 4.2 ships default-on; opt-in still needed on Agave 4.0/4.1 |
...
validator adoption was critical to unlocking 100M CU blocks. That threshold —
supermajority (more than two-thirds) of stake running XDP — was reached on
June 30, 2026, clearing the way for the network to move forward on larger
block sizes.
...
XDP is scheduled to be turned on by default in Agave 4.2.
...
| Agave 4.2+    | Default on (scheduled) | None once 4.2 ships           |
